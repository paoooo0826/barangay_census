      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-5 py-6 sm:px-8 lg:px-12">
        <header className="flex items-center justify-between gap-4 border-b border-white/10 pb-5">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-blue-500 text-white shadow-lg shadow-blue-950/30">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-400">
                Resident Information &amp; Service Portal
              </p>
            </div>
          </div>
        ...
        <div className="grid flex-1 items-center gap-12 py-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-20 lg:py-16">
          <section aria-labelledby="portal-heading">
            ...
            <h1
              id="portal-heading"
              className="mt-7 max-w-3xl text-4xl font-black leading-[1.05] tracking-tight sm:text-5xl lg:text-7xl"
            >
              Barangay services,
          ...
          <section
            aria-labelledby="choose-portal-heading"
            className="rounded-[2rem] border border-white/15 bg-white p-6 text-slate-900 shadow-2xl shadow-black/30 sm:p-8"
          >
            <div className="mb-7">
            ...
            <div className="space-y-4">
              <button
                type="button"
                onClick={onResident}
                className="group flex w-full items-center gap-4 rounded-2xl border border-blue-200 bg-blue-50 p-5 text-left transition duration-200 hover:-translate-y-0.5 hover:border-blue-400 hover:bg-blue-100 hover:shadow-lg hover:shadow-blue-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2"
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 text-sm text-slate-600">
                    Register, sign in, and request services
                  </p>
                </div>
                <ArrowRight
                  aria-hidden="true"
                  className="shrink-0 text-blue-600 transition-transform group-hover:translate-x-1"
                  size={21}
                />
              </button>
              ...
              <button
                type="button"
                onClick={onAdmin}
                className="group flex w-full items-center gap-4 rounded-2xl border border-emerald-200 bg-emerald-50 p-5 text-left transition duration-200 hover:-translate-y-0.5 hover:border-emerald-400 hover:bg-emerald-100 hover:shadow-lg hover:shadow-emerald-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-600 focus-visible:ring-offset-2"
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 text-sm text-slate-600">
                    Review records and manage services
                  </p>
                </div>
                <ArrowRight
                  aria-hidden="true"
                  className="shrink-0 text-emerald-600 transition-transform group-hover:translate-x-1"
                  size={21}
                />
              </button>
            </div>
            ...
            <div className="mt-6 flex items-start gap-3 rounded-2xl bg-slate-100 p-4 text-xs leading-5 text-slate-600">
              ...
              />
              <p>
                Personal information is protected by account authentication and
